...
@RequestMapping("/user/freeboard/") /*폼 채크 아웃이 공통으로 쓰는거는 이렇게 미리 선언할 수 있음*/
public class JoinControllerFreeboard {
	@Autowired
...
//		return "user/join/loginForm";
	...
	public String loginCheck(String mem_id,
		...
		if(memberInfo == null){
			...
			return "redirect:/user/freeboard/freeboardForm.do?message="+message;
		}else {
