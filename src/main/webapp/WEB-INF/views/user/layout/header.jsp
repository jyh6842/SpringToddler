		...
		<div class="topbar-main">
			...
			<div class="loginForm nav navbar navbar-top-links navbar-right"
				...
				<ul>
					...
					<li>&nbsp;</li>	
			        <li class="dropdown">
			        	<button type="button" class="btn btn-warning btn-sm" id="btn_login">로그인</button>
			        	<button type="button" class="btn btn-debug btn-sm" id="memberJoin">회원가입</button>
				    </li>
				</ul>	    
			</div>
			</c:if>
...
// document.querySelector('input[name=mem_id]');
// document.querySelector('input[name=mem_pass]');
// 	location.href = ''
// }
...
$(function(){
    ...
    var $frm = $('<form action="${pageContext.request.contextPath }/user/freeboard/loginCheck.do" method="post"></form>');
